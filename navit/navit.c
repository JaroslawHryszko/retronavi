...
int global_hide_labels_line = 0; // 1 -> hide text labels along lines (street names, river names, contours)
int global_hide_labels_point = 0; // 1 -> hide text labels on points (city names, POI labels)

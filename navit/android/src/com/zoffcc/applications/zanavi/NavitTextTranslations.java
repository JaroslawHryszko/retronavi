...
public class NavitTextTranslations
{
	...
	public static void init()
	{
		...
		p(k, v);
		k = "Map Preview";
		v = new String[] { "en","Map Preview", "fr","Aperçu de la carte", "de","Kartenvorschau", "el","Προεπισκόπηση χάρτη", "pl","Podgląd mapy"};
		p(k, v);
		...
		p(k, v);
		k = "checking map ...";
		v = new String[] { "en","checking map ...", "fr","Carte en cours de vérification", "de","prüfe Karte ...", "el","έλεγχος χάρτη...", "hu","Térkép ellenőrzése...", "es","Revisando el mapa ...", "pl","sprawdzanie mapy ..."};
		p(k, v);
		k = "MD5 mismatch";
		...
		p(k, v);
		k = "Index download";
		v = new String[] { "en","Index download", "fr","Index telechargé", "el","λήψη ευρετηρίου", "hu","Index letöltése", "es","Descargando el índice", "pl","Pobieranie indeksu"};
		p(k, v);
		...
		p(k, v);
		k = "checking";
		v = new String[] { "en","checking", "fr","contrôle en cours", "de","prüfe", "el","έλεγχος", "es","comprobando", "pl","sprawdzanie"};
		p(k, v);
		k = "download maps";
		...
		v = new String[] { "en","Your GPS is disabled, do you want to enable it?", "fr","GPS désactivé, voulez vous l'activer ?", "de","GPS ist nicht aktiviert. Soll es jetzt aktiviert werden?", "el","Το GPS είναι απενεργοποιημένο, θέλετε να ενεργοποιηθεί;", "es","Su GPS está desactivado. ¿Desea activarlo?", "pl","GPS jest wyłączony, czy chcesz go włączyć?"};
		p(k, v);
		k = "Yes";
		v = new String[] { "en","Yes", "nl","Ja", "fr","Oui", "de","Ja", "el","Ναι", "hu","Igen", "es","Sí", "pl","Tak"};
		p(k, v);
		k = "No";
		v = new String[] { "en","No", "nl","Nee", "fr","Non", "de","Nein", "el","Όχι", "hu","Nem", "pl","Nie"};
		p(k, v);
		k = "No Maps installed";
		v = new String[] { "en","No Maps installed", "nl","geen kaarten geinstalleerd", "fr","Aucune carte installée", "de","Keine Karten installiert", "el","Δεν έχουν εγκατασταθεί χάρτες", "es","Los mapas no encontrados", "pl","Brak zainstalowanych map"};
		p(k, v);
		k = "Please download a map";
		v = new String[] { "en","Please download a map", "fr","Veuillez télécharger une carte", "de","Bitte eine Karte runterladen", "el","Παρακαλώ κάντε λήψη ενός χάρτη", "es","Por favor, descargue un mapa", "pl","Pobierz mapę"};
		p(k, v);
		...
		v = new String[] { "en","driving to Home Location", "fr","Retour à la maison", "de","navigiere zur Heimadresse", "el","οδήγηση στο Σπίτι", "es","conduciendo hacia la ubicación de inicio", "pl","Nawigacja do domu"};
		p(k, v);
		k = "No Home Location set";
		v = new String[] { "en","No Home Location set", "fr","Aucun domicile définit", "de","keine Heimadresse gesetzt", "el","Δεν έχει οριστεί τοποθεσία Σπιτιού", "es","No hay un conjunto de ubicaciones de inicio", "pl","Nie ustawiono lokalizacji domu"};
		p(k, v);
		k = "Some Maps are too old!";
		v = new String[] { "en","Some Maps are too old!", "nl","sommige kaarten zijn te oud", "fr","Certaines cartes sont trop anciennes !", "de","Einge Karten sind zu alt!", "el","Κάποιοι χάρτες είναι πολύ παλιοί", "es","Algun mapa está desactualizado", "pl","Niektóre mapy są zbyt stare!"};
		p(k, v);
		k = "Please update your maps";
		v = new String[] { "en","Please update your maps", "fr","Veuillez mettre à jour vos cartes", "de","Bitte Karten updaten", "el","Παρακαλώ ενημερώστε τους χάρτες σας", "es","Por favor, actualice los mapas", "pl","Zaktualizuj mapy"};
		p(k, v);
		k = "No Index for some Maps";
		v = new String[] { "en","No Index for some Maps", "fr","Pas d'index pour certaines cartes", "de","Kein Indexfile bei manchen Karten", "pl","Brak indeksu dla niektórych map"};
		p(k, v);
		k = "Share Destination";
		v = new String[] { "en","Share Destination", "fr","Partager votre destination", "de","Teile Ziel", "el","Διαμοιρασμός Προορισμού", "hu","Cél megosztása", "es","Compartir destino", "pl","Udostępnij cel"};
		p(k, v);
		k = "Share my Location";
		v = new String[] { "en","Share my Location", "fr","Partager ma localisation", "de","teile Standort", "el","Διαμοιρασμός Τοποθεσίας μου", "es","Compartir mi ubicación", "pl","Udostępnij moją lokalizację"};
		p(k, v);
		...
		p(k, v);
		k = "downloading map";
		v = new String[] { "en","downloading map", "fr","téléchargement de la carte", "de","lade Karte", "el","λήψη χάρτη", "es","descargando el mapa", "pl","pobieranie mapy"};
		p(k, v);
		k = "Zoom to Route";
		...
		v = new String[] { "en","replay a ZANavi gps file", "fr","relire un fichier gps ZANavi", "el","αναπαραγωγή αρχείου gps ZANavi ξανά", "pl","odtwórz plik GPS"};
		p(k, v);
		k = "run YAML tests";
		v = new String[] { "en","run YAML tests", "pl","uruchom testy YAML"};
		p(k, v);
		k = "clear GPX map";
		v = new String[] { "en","clear GPX map", "fr","effacer la carte GPX", "de","GPX routen entfernen", "el","καθαρισμός χάρτη GPX", "hu","GPX térkép törlése", "sk","Zmazať GPX mapu", "es","Borrar el mapa GPX", "pl","wyczyść mapę GPX"};
		p(k, v);
		k = "Demo Vehicle";
		...
		p(k, v);
		k = "toggle Routegraph";
		v = new String[] { "en","toggle Routegraph", "fr","afficher le graphique routier", "de","Routegraph anzeigen", "hu","Útvonal gfáf ki/be", "es","Conmuta el gráfico de la ruta", "pl","przełącz graf trasy"};
		p(k, v);
		k = "export Destinations";
		v = new String[] { "en","export Destinations", "fr","exporter les destinations", "de","Ziele exportieren", "es","Exportar la lista de destinos", "pl","eksportuj cele"};
		p(k, v);
		k = "import Destinations";
		v = new String[] { "en","import Destinations", "fr","importer les destinations", "de","Ziele importieren", "es","Importar la lista de destinos", "pl","importuj cele"};
		p(k, v);
		k = "send feedback";
		v = new String[] { "en","send feedback", "fr","envoyer un commentaire", "de","feedback senden", "hu","Vélemény küldése", "es","enviar comentarios", "pl","wyślij opinię"};
		p(k, v);
		k = "online Help";
		...
		p(k, v);
		k = "About";
		v = new String[] { "en","About", "de","Über", "pl","O aplikacji"};
		p(k, v);
		k = "Target in gmaps";
		...
		p(k, v);
		k = "Share";
		v = new String[] { "en","Share", "fr","Partager", "de","Teilen", "hu","Megosztás", "es","Recurso compartido", "pl","Udostępnij"};
		p(k, v);
		k = "Stop Navigation";
		...
		p(k, v);
		k = "Meeting Point";
		v = new String[] { "en","Meeting Point", "fr","Point de rencontre", "de","Treffpunkt", "hu","Találkozás helye", "es","Punto de encuentro", "pl","Punkt spotkania"};
		p(k, v);
		k = "my Location";
		v = new String[] { "en","my Location", "fr","ma localisation", "de","Standort", "es","mi Localización", "pl","moja lokalizacja"};
		p(k, v);
		...
		p(k, v);
		k = "No search string";
		v = new String[] { "en","No search string", "fr","Recherche vide", "de","Kein Suchtext", "hu","Nincs keresési szöveg", "es","Sin cadena de búsqueda", "pl","Brak frazy wyszukiwania"};
		p(k, v);
		...
		v = new String[] { "en","there was a problem with sending feedback", "fr","Il y a eu un problème lors de l'envoi des commentaires", "de","Problem beim senden von feedback", "hu","A vélemény küldése közben hiba lépett fel", "es","Hubo un problema con el envío de comentarios", "pl","wystąpił problem z wysyłaniem opinii"};
		p(k, v);
		...
		p(k, v);
		k = "POI";
		v = new String[] { "en","POI", "fr","PdI", "hu","POI (ÉP)", "pl","POI"};
		p(k, v);
		k = "No Results found!";
		...
		p(k, v);
		k = "ERROR";
		v = new String[] { "en","ERROR", "de","FEHLER", "pl","BŁĄD"};
		p(k, v);
		...
		p(k, v);
		k = "Ok";
		v = new String[] { "en","Ok", "ar","تم", "zh","确定", "zh_HK","好", "el","Εντάξει", "hu","Rendben", "pl","Ok"};
		p(k, v);
		k = "device space";
		v = new String[] { "en","device space", "fr","Espace libre", "de","Speicherplatz", "el","χώρος στη συσκευή", "hu","Eszköz szabad tárhely", "sk","Voľné miesto v zariadení", "es","espacio en su dispositivo", "pl","pamięć urządzenia"};
		p(k, v);
		k = "loading ...";
		v = new String[] { "en","loading ...", "de","laden ...", "pl","ładowanie ..."};
		p(k, v);
		k = "Cancel";
		v = new String[] { "en","Cancel", "fr","Annuler", "de","Abbrechen", "hu","Mégsem", "es","Cancelar", "pl","Anuluj"};
		p(k, v);
		k = "Send feedback via email ...";
		v = new String[] { "en","Send feedback via email ...", "fr","Envoyer les commentaires par courriel", "de","Feedback per Email senden ...", "es","Envíe sus comentarios por correo electrónico ...", "pl","Wyślij opinię emailem ..."};
		p(k, v);
		k = "Send email with attachments";
		v = new String[] { "en","Send email with attachments", "de","Email mit Anhang senden", "pl","Wyślij email z załącznikami"};
		p(k, v);
		k = "No Email App found";
		v = new String[] { "en","No Email App found", "de","kein Email App installiert", "pl","Nie znaleziono aplikacji email"};
		p(k, v);
		k = "Please press BACK again to Exit";
		v = new String[] { "en","Please press BACK again to Exit", "fr","Appuyez une deuxième fois sur retour pour quitter", "de","nochmal BACK drücken um App zu beenden", "es","Por favor, pulse de nuevo ATRÁS", "pl","Naciśnij WSTECZ ponownie, aby wyjść"};
		p(k, v);
		k = "google search API is not working at this moment, try offline search";
		v = new String[] { "en","google search API is not working at this moment, try offline search", "fr","L'API de recherche Google ne fonctionne pas en ce moment, essayez une recherche hors-ligne", "de","Google Suche funktioniert im Moment nicht, bitte offline Suche verwenden", "hu","A Google keresö API nem müködik, próbáld késöbb", "es","La búsqueda de la API de google no está funcionando en este momento, busque fuera de línea", "pl","Wyszukiwanie Google nie działa, spróbuj wyszukiwania offline"};
		p(k, v);
		k = "saving route to GPX-file";
		v = new String[] { "en","saving route to GPX-file", "fr","enregistrement de l'itinéraire vers le fichier GPX", "es","Guardando la ruta en archivo GPX", "pl","zapisywanie trasy do pliku GPX"};
		p(k, v);
		k = "saving route to GPX-file failed";
		v = new String[] { "en","saving route to GPX-file failed", "fr","l'enregistrement de l'itinéraire vers le fichier GPX a échoué", "de","saving route to GPX-file", "es","No fue posible guardar la ruta en archivo GPX", "pl","zapisywanie trasy do pliku GPX nie powiodło się"};
		p(k, v);
		...
		p(k, v);
		k = "Search results";
		v = new String[] { "en","Search results", "nl","Zoekresultaten", "fr","Résultats de la recherche", "de","Suchergebnisse", "pl","Wyniki wyszukiwania"};
		p(k, v);
		k = "Destination set";
		v = new String[] { "en","Destination set", "nl","Bestemming ingesteld", "fr","Fixer la destination", "de","Ziel gesetzt", "el","Ορισμός προορισμού", "hu","Cél beadva", "sk","Cieľ bol určený", "es","Conjunto de destinos", "pl","Cel ustawiony"};
		p(k, v);
		...
		v = new String[] { "en","downloading, please wait ...", "fr","téléchargement, veuillez patienter...", "de","laden, bitte warten ...", "hu","Letöltés ... kérlek, várj!", "es","descargando, espere, por favor", "pl","pobieranie, proszę czekać ..."};
		p(k, v);
		...
		v = new String[] { "en","index search", "fr","Recherche indexée", "de","index suche", "hu","Indexelt keresés", "pl","Wyszukiwanie z indeksem"};
		p(k, v);
		k = "__PREF__summ__use_index_search";
		v = new String[] { "en","use faster and better index search [donate version]", "fr","recherche indexée, plus rapide et precise [appli donateur]", "de","schnellere index suche verwenden [donate version]", "hu","Indexelt keresés", "pl","Szybsze wyszukiwanie adresów (wymaga plików indeksu)"};
		p(k, v);
		k = "__PREF__title__trafficlights_delay";
		v = new String[] { "en","traffic lights", "fr","Feux tricolores", "de","Ampeln", "el","φανάρια", "hu","Jelzölámpa késlekedés", "pl","Opóźnienie na światłach"};
		p(k, v);
		k = "__PREF__summ__trafficlights_delay";
		v = new String[] { "en","set delay of traffic lights for routing", "fr","Ralentissement lié aux feux tricolores", "de","Verzögerung durch Amplen auf der Route", "el","ορίστε την  καθυστέρηση των φαναριών για την δρομολόγηση", "hu","Jelzölámpa késlekedés", "pl","Opóźnienie dla sygnalizacji świetlnej"};
		p(k, v);
		...
		v = new String[] { "en","filter special chars", "fr","filtrer les caractères spéciaux", "de","sonderzeichen filtern", "hu","Ékezetes betük szürése", "pl","Filtruj znaki specjalne w mowie"};
		p(k, v);
		k = "__PREF__summ__speak_filter_special_chars";
		v = new String[] { "en","filter special chars when speaking streetnames", "fr","Ne pas prononcer les caractères spéciaux dans les noms de rues", "de","sonderzeichen beim sprechen von Straßennamen herausfiltern", "hu","Ékezetes betük szürése", "pl","Usuwa znaki specjalne z komunikatów głosowych"};
		p(k, v);
		...
		v = new String[] { "en","2D/3D toggle", "fr","Basculer 2D/3D", "de","2D/3D Knopf", "hu","2D / 3d átkapcsolás", "pl","Przycisk 2D/3D"};
		p(k, v);
		k = "__PREF__summ__show_2d3d_toggle";
		v = new String[] { "en","show 2D/3D toggle instead of Map off/on toggle", "fr","Affiche un bouton 2D/3D à la place de carte on/off.", "de","2D/3D Knopf statt Karte-aus-knopf anzeigen", "hu","2D / 3d átkapcsolás", "pl","Pokaż przycisk przełączania widoku 2D/3D"};
		p(k, v);
		...
		v = new String[] { "en","Autozoom", "fr","Zoom auto", "de","Autozoom", "hu","Automatikus zoom ki / be", "pl","Auto-zoom"};
		p(k, v);
		k = "__PREF__summ__autozoom_flag";
		v = new String[] { "en","set map zoom automatically according to driving speed", "fr","Réglage du zoom automatique en fonction de la vitesse.", "de","Kartenzoom nach Fahrtgeschwindigkeit automatisch einstellen", "hu","Automatikus zoom ki / be", "pl","Automatyczne dopasowanie zoomu podczas nawigacji"};
		p(k, v);
		...
		v = new String[] { "en","filtering", "fr","Re-traitement de la carte", "de","filtering", "hu","Térkép szürés", "pl","Filtrowanie mapy"};
		p(k, v);
		k = "__PREF__summ__use_map_filtering";
		v = new String[] { "en","filtering draws map more smoothly, but needs more CPU", "fr","Affichage plus net et fluide mais solicite plus le processeur.", "de","filtering einschalten, zeichnet die Karte schöner. braucht aber mehr Leistung", "hu","Térkép szürés", "pl","Rysuj mapę z filtrowaniem (ładniej, ale więcej CPU)"};
		p(k, v);
		...
		v = new String[] { "en","High DPI", "fr","Ecrans HD", "de","High DPI", "hu","Szükítés nagy felbontásnál", "pl","Zmniejsz na ekranach HD"};
		p(k, v);
		k = "__PREF__summ__shrink_on_high_dpi";
		v = new String[] { "en","use 240dpi on high density displays (> 320dpi). needs RESTART!", "fr","Limite la resolution a 240DPI sur les écrans HD (>320DPI)", "de","240 dpi auf Hochauflösenden Displays (> 320dpi) verwenden. braucht RESTART!", "pl","Zmniejsz elementy na ekranach o wysokiej rozdzielczości"};
		p(k, v);
		k = "__PREF__title__streets_only";
		v = new String[] { "en","Streets only", "fr","Rues uniquement", "de","Nur Straßen", "hu","Csak utcák", "pl","Tylko ulice"};
		p(k, v);
		k = "__PREF__summ__streets_only";
		v = new String[] { "en","show only streets on map. map display is faster with this setting", "fr","N'affiche ques les rues sur la cartes. Ce réglage ACCELERE beaucoup l'affichage", "de","auf der Karte nur Straßen anzeigen. keine anderen Objekte. Karte wird dadurch etwas schneller gezeichnet", "pl","Pokaż tylko ulice na mapie"};
		p(k, v);
		...
		v = new String[] { "en","set as Home Location", "nl","als thuislocatie instellen", "fr","définir comme domicile", "de","als Heimadresse setzen", "es","Establecer como ubicación de inicio", "pl","Ustaw jako dom"};
		p(k, v);
		k = "Rename Destination";
		v = new String[] { "en","Rename Destination", "ar","إعادة تسمية المقصد", "pt","Renomear Destino", "pt_BR","Renomear Destino", "zh","重命名目的地", "zh_HK","重新命名目的地", "cs","Přejmenovat cíl", "nl","Bestemming hernoemen", "fr","Renommer la destination", "de","Ziel umbenennen", "el","Μετονομασία Προορισμού", "hu","Cél átnevezése", "it","Rinomina Destinazione", "pl","Zmień nazwę celu", "sk","Premenovať cieľ", "es","Renombrar destino"};
		p(k, v);
		k = "address search";
		v = new String[] { "en","address search", "fr","recherche d'adresse", "de","Adresssuche", "es","Búsqueda por dirección", "pl","szukaj adresu"};
		p(k, v);
		k = "Enter Destination";
		...
		v = new String[] { "en","click to activate Index Search", "fr","Cliquer pour activer la recherche indexée", "de","hier drücken um den Suchindex zu aktivieren", "pl","kliknij, aby włączyć wyszukiwanie z indeksem"};
		p(k, v);
		...
		p(k, v);
		k = "last searches";
		v = new String[] { "en","last searches", "fr","dernières recherches", "de","letzte Eingaben", "es","últimas búsquedas", "pl","ostatnie wyszukiwania"};
		p(k, v);
		k = "Streetname";
		v = new String[] { "en","Streetname", "nl","Straatnaam", "fr","Nom de rue", "de","Straße", "hu","Utcanév", "es","Nombre de la calle", "pl","Nazwa ulicy"};
		p(k, v);
		k = "Town";
		v = new String[] { "en","Town", "nl","Plaats", "fr","Ville", "de","Ort", "hu","Város", "es","Ciudad", "pl","Miasto"};
		p(k, v);
		k = "Address or POI-Name";
		v = new String[] { "en","Address or POI-Name", "fr","Adresse ou point d'interêt", "de","Adresse oder POI-Name", "hu","Cím vagy POI-név", "es","Dirección del nombre del punto de interés", "pl","Adres lub nazwa POI"};
		p(k, v);
		k = "Report Bugs";
		v = new String[] { "en","Report Bugs", "de","Fehler melden", "pl","Zgłoś błędy"};
		p(k, v);
		k = "F-Droid";
		v = new String[] { "en","F-Droid", "pl","F-Droid"};
		p(k, v);
		k = "Welcome to ZANavi offline Navigation";
		v = new String[] { "en","Welcome to ZANavi offline Navigation", "de","Willkommen bei ZANavi offline Navigation", "pl","Witaj w RetroNavi - nawigacja offline"};
		p(k, v);
		k = "OpenStreetMap data is available under the Open Database Licence";
		v = new String[] { "en","OpenStreetMap data is available under the Open Database Licence", "pl","Dane OpenStreetMap dostępne na licencji Open Database Licence"};
		p(k, v);
		k = "Download";
		v = new String[] { "en","Download", "pl","Pobierz"};
		p(k, v);
		k = "Stop map download?";
		v = new String[] { "en","Stop map download?", "nl","Kaart download stoppen?", "fr","Arrêter le téléchargement de la carte?", "de","Kartendownload beenden?", "hu","Térkép letöltés leállítása", "es","¿Parar la descarga del mapa?", "pl","Zatrzymać pobieranie mapy?"};
		p(k, v);
		k = "press HOME to download in the background";
		v = new String[] { "en","press HOME to download in the background", "fr","Appuyer sur HOME pour télécharger en arriere plan", "de","drücke HOME um die Karten im Hintergrund zu laden", "es","pulsar HOME para descargar en segundo plano", "pl","naciśnij HOME, aby pobierać w tle"};
		p(k, v);
		k = "Enter your Feedback text";
		v = new String[] { "en","Enter your Feedback text", "fr","Saisissez votre commentaire", "de","Feedbacktext eingeben", "hu","Vélemény beírása", "es","Introduzca el texto en Comentarios", "pl","Wpisz treść opinii"};
		p(k, v);
		k = "send";
		v = new String[] { "en","send", "nl","verzend", "fr","envoyer", "de","senden", "hu","Küldés", "es","enviar", "pl","wyślij"};
		p(k, v);
		k = "Do you want to delete this map?";
		v = new String[] { "en","Do you want to delete this map?", "de","Karte löschen?", "pl","Czy chcesz usunąć tę mapę?"};
		p(k, v);
		...
		p(k, v);
		k = "generate QR code";
		v = new String[] { "en","generate QR code", "nl","QR code genereren", "fr","générer un code QR", "de","generiere QR Code", "es","Generar un código QR", "pl","generuj kod QR"};
		p(k, v);
		...
		p(k, v);
		k = "OK";
		v = new String[] { "en","OK", "pl","OK"};
		p(k, v);
		k = "ZANavi has recently crashed, please submit the crashlog";
		v = new String[] { "en","ZANavi has recently crashed, please submit the crashlog", "de","ZANavi ist abgestürzt, bitte Crashlog senden", "pl","Aplikacja niedawno się zawiesiła, wyślij raport o błędzie"};
		p(k, v);
		k = "Log may contain private and sensitive data!";
		v = new String[] { "en","Log may contain private and sensitive data!", "de","Log kann sensible Daten enthalten!", "pl","Log może zawierać prywatne i wrażliwe dane!"};
		p(k, v);
		k = "Grant Permissions";
		v = new String[] { "en","Grant Permissions", "pl","Przyznaj uprawnienia"};
		p(k, v);
		k = "you have just updated ZANavi";
		v = new String[] { "en","you have just updated ZANavi", "de","ZANavi wurde upgedated", "pl","Właśnie zaktualizowano RetroNavi"};
		p(k, v);
		k = "select your storage and download a Map for your Area";
		v = new String[] { "en","select your storage and download a Map for your Area", "de","Speicherort wählen und Karte für deine Region laden", "pl","Wybierz pamięć i pobierz mapę dla swojego regionu"};
		p(k, v);
		k = "Index missing, please delete your maps and download them again";
		v = new String[] { "en","Index missing, please delete your maps and download them again", "de","Kartenindex fehlt, bitte Karten löschen und nochmals laden", "pl","Brak indeksu, usuń mapy i pobierz je ponownie"};
		p(k, v);
		k = "Next";
		v = new String[] { "en","Next", "de","Weiter", "pl","Dalej"};
		p(k, v);
		k = "Skip";
		v = new String[] { "en","Skip", "de","Überspringen", "pl","Pomiń"};
		p(k, v);
		k = "Permissions";
		v = new String[] { "en","Permissions", "de","Berechtigungen", "pl","Uprawnienia"};
		p(k, v);
		k = "ZANavi needs all the Permissions granted";
		v = new String[] { "en","ZANavi needs all the Permissions granted", "de","ZANavi braucht diese Berechtigungen", "pl","RetroNavi potrzebuje wszystkich uprawnień"};
		p(k, v);
		k = "Submit Log";
		v = new String[] { "en","Submit Log", "de","Log senden", "pl","Wyślij raport"};
		p(k, v);
		k = "reading crash info ...";
		v = new String[] { "en","reading crash info ...", "de","lade Logdaten ...", "pl","odczytywanie informacji o awarii ..."};
		p(k, v);
		k = "No, thanks";
		v = new String[] { "en","No, thanks", "de","Nein Danke", "pl","Nie, dzięki"};
		p(k, v);
		k = "Maps";
		v = new String[] { "en","Maps", "de","Karten", "pl","Mapy"};
		p(k, v);
		k = "Index";
		v = new String[] { "en","Index", "pl","Indeks"};
		p(k, v);
		k = "Crashlog";
		v = new String[] { "en","Crashlog", "de","Logdaten", "pl","Raport awarii"};
		p(k, v);
		k = "Preparing Storage";
		v = new String[] { "en","Preparing Storage", "de","Speicherort vorbereiten", "pl","Przygotowywanie pamięci"};
		p(k, v);
		k = "please wait ...";
		v = new String[] { "en","please wait ...", "de","bitte warten ...", "pl","proszę czekać ..."};
		p(k, v);
		...
		p(k, v);
		k = "Voice Search";
		v = new String[] { "en","Voice Search", "fr","Recherche vocale", "de","Sprachsuche", "pl","Wyszukiwanie głosowe"};
		p(k, v);
		k = "Click to talk";
		v = new String[] { "en","Click to talk", "fr","Appuyer puis parlez", "de","zum sprechen drücken", "hu","Beszélgetéshez katt ide", "es","Pulse aquí para hablar", "pl","Kliknij, aby mówić"};
		p(k, v);
		k = "Voice Search, speak your Destination";
		v = new String[] { "en","Voice Search, speak your Destination", "fr","Recherche vocale de la destination", "de","Sprachsuche", "hu","Hang alapú keresés, mondd a célt", "es","Búsqueda por voz, diga su Destino", "pl","Wyszukiwanie głosowe, powiedz swój cel"};
		p(k, v);
		k = "Google Speechrecognition not found";
		v = new String[] { "en","Google Speechrecognition not found", "fr","Reconnaissance automatique de la parole Google non trouvée", "de","Google Text-in-Sprache nicht installiert", "hu","Nem találom a Google beszédfelismeröt!", "es","No se ha encontrado el reconocimiento por voz de google", "pl","Nie znaleziono rozpoznawania mowy Google"};
		p(k, v);
		k = "you said:";
		v = new String[] { "en","you said:", "fr","vous avez dit :", "de","Sie sagten:", "hu","Ezt mondtad:", "es","Usted dijo:", "pl","powiedziałeś:"};
		p(k, v);
		k = "searching for the location";
		v = new String[] { "en","searching for the location", "fr","recherche de l'emplacement", "de","Ort wird gesucht", "hu","Hely keresése", "es","buscando la ubicación", "pl","szukanie lokalizacji"};
		p(k, v);
		k = "Find Destination";
		v = new String[] { "en","Find Destination", "fr","Rechercher une destination", "de","Ort finden", "hu","Hely keresése", "es","Buscar destino", "pl","Znajdź cel"};
		p(k, v);
		k = "Google did not find this location. Please search again";
		v = new String[] { "en","Google did not find this location. Please search again", "fr","Google n'a pas trouvé cet emplacement.", "de","Dieser Ort wurde von Google nicht gefunden. Bitte versuchen Sie es nochmals", "hu","A Google nem találja azt a helyet. Keress újra!", "es","Google no encontró esta ubicación. Por favor, busque de nuevo", "pl","Google nie znalazło tej lokalizacji. Spróbuj ponownie"};
		p(k, v);
		k = "What's here";
